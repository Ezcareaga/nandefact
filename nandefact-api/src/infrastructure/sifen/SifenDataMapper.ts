...
export class SifenDataMapper {
   ...
   */
  static mapFacturaToData(factura: Factura, _comercio: Comercio, cliente: Cliente): SifenData {
    ...
    const clienteMapeado = this.mapCliente(cliente);
    ...
    return {
      ...
      items: this.mapItemsToSifenItems(factura.items),
    };
  }
   ...
   */
  private static mapCliente(cliente: Cliente): SifenData['cliente'] {
