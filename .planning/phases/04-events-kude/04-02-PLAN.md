...
must_haves:
  ...
  key_links:
    ...
    - from: "nandefact-api/src/application/facturacion/EnviarKuDE.ts"
      ...
      via: "comercioRepository.findById() to load comercio data for KuDE"
      pattern: "comercioRepository\\.findById"
    - from: "nandefact-api/src/application/facturacion/EnviarKuDE.ts"
      to: "nandefact-api/src/domain/cliente/IClienteRepository.ts"
      via: "clienteRepository.findById() to load cliente data for KuDE"
      pattern: "clienteRepository\\.findById"
---
